        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          >
            ...
            <div>
              ...
              <textarea
                rows={3}
                className="w-full p-3 resize-none border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
                placeholder="Please enter a short"
                onChange={(e) =>
